// interface HoursAndTarget is redundant while using express
// to handle passing args to calculateExercise()
...
// the following commented out code is redundant as long as we
// are using express to handle passing args to calculateExercise()
...
export const calculateExercise = (target: number, hours: number[]): Result => {
